...
Capsule.create!(name: "Futuristic Escape Capsule", description: "Step into different time periods for a unique experience.", price: 25, address: "123 Main St, Springfield, IL 62701", user_id: user.id)
